package com.kerollosragaie.globalfly.helpers
...
import com.kerollosragaie.globalfly.activities.DestinationDetailActivity
...
class DestinationAdapter(private val destinationList: List<Destination>) : RecyclerView.Adapter<DestinationAdapter.ViewHolder>() {
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		...
		holder.itemView.setOnClickListener { v ->
			...
			//send and object to other activity using intent
			intent.putExtra(DestinationDetailActivity.ARG_DESTINY_OBJECT, holder.destination)
